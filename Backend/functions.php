...
function nav_bar()
{
  ...
  <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbar navbar-expand-lg" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
